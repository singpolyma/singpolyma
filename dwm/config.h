...
static Key keys[] = {
	...
	{ 0,                            XK_F6,     spawn,          SHCMD("rxvt -title cmus -name cmus -e cmus") },
	{ MODKEY,                       XK_F6,     spawn,          SHCMD("rxvt -title mediacentre -name mediacentre -e ssh singpolyma.dnsalias.net") },
	{ 0,                            XK_F7,     spawn,          SHCMD("sensible-browser") },
	{ MODKEY,                       XK_F7,     spawn,          SHCMD("psi") },
	{ 0,                            XK_F8,     spawn,          SHCMD("rxvt -title mutt -name mutt -e mutt") },
	{ MODKEY,                       XK_F8,     spawn,          SHCMD("rxvt -title irssi -name irssi -e irssi") },
